...
import { BookmarkInfo, LikeInfo, PostData, PostWithRepost } from '@/lib/types'
...
import ExtendedPostComponent from './ExtendedPostComponent'
...
import ReTweetButton from './components/ReTweet'
import { useRouter } from 'next/navigation'
import { ImageCarousel } from './ImageCarsoul'
export default function Posts({ post, showMedia = true, showInteractions = true }: Props) {
        ...
        <div className=' px-6 sm:px-4 pt-5 pb-3 relative'>
          <div className='flex gap-3 w-full text-gray-100'>
            <div className='w-fit'>
              <Link
                ...
                <img
                  ...
                  src={post.user.image ||  '/avatar-placeholder.jpg'}
                 

                  className='rounded-full brightness-90 border border-gray-700 h-11 w-12'
                  alt='profile-pic'
                />
            ...
            <div
              ...
              {showInteractions &&
                <div className='flex justify-between mt-[0.5rem] -ml-[4px] text-gray-400'>
